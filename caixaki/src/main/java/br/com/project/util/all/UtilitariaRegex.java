...
public class UtilitariaRegex implements Serializable{
	...
	public String verificaAceitaCaracteresAaZe0a9Acentos(String string) {
		...
		Pattern pattern = Pattern
				.compile("[·‡ÈËÌÏÛÚ˙˘„Á qwertyuiopasdfghjklzxcvbnm QWERTY«UIOPASDFGHJKLZXCVBNM 0123456789]");
	...
	public String retiraAcentos(String string) {
		...
		aux = aux.replaceAll("[ËÈÍÎ»… À]", "e");
		aux = aux.replaceAll("[˚˘¸˙€⁄Ÿ‹]", "u");
		aux = aux.replaceAll("[ÔÓÌÏœŒÕÃ]", "i");
		aux = aux.replaceAll("[‡‚·‰„¡¿¬ƒ]", "a");
		aux = aux.replaceAll("[ÛÚÙˆı”“‘÷]", "o");
		return aux;
	}
